...
```
<a id="jenkins"></a>
## <img width="4%" style="vertical-align:middle" title="Jenkins" src="media/logo/Jenkins.svg"> </a> Сборка в <a target="_blank" href="[[https://jenkins.autotests.cloud/job/018_Kontur.ru_KuryshevaAR/](https://jenkins.autotests.cloud/job/Students/job/018_Kontur.ru_KuryshevaAR/)](https://jenkins.autotests.cloud/job/Students/job/018_Kontur.ru_KuryshevaAR/)"> Jenkins </a>
